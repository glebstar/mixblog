...
<head>
    ...
    <title>Административная панель - mix</title>
...
<div id="wrapper">
        ...
        <div class="navbar-inner">
            <div class="container">
                <div class="brand-wrap pull-left">
                    <div class="brand-img">
                        <a class="brand" href="/">
                            <!--<img src="/adm/assets/images/logo.png" alt="">-->
                            <p>Мой блог</p>
                        </a>
                    </div>
                </div>
                        ...
                        <div id="user-info" class="clearfix">
                            ...
                            <div class="avatar">
                                <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                                    <img src="/adm/assets/images/pp.jpg" alt="Avatar">
                                </a>
    ...
    <footer id="footer">
        <div class="footer-left">MixBlog</div>
